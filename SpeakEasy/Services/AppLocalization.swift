...
enum AppLocalization {
    ...
    static let objectNames: [String: String] = [
        ...
        "Nature": "自然", "nature": "自然", "Natural": "自然",
        "Living": "有生命", "Non-living": "无生命",
        "Living things": "有生命的", "Non-living things": "无生命的",
        "Man-made": "人造的", "Objects": "物品",
        "Things": "物品", "From Outdoors": "户外的", "Made by People": "人造的",
        "Outdoors": "户外", "Things that fly": "会飞的", "Things that swim": "会游泳的",
        "Things with legs": "有脚的", "Things without legs": "没有脚的",
        "Things that need electricity": "需要电的", "Things that don't": "不需要电的",
        "Hot things": "热的", "Cold things": "冷的",
        "Big animals": "大动物", "Small animals": "小动物",
        "Things you wear": "穿的", "Things you eat": "吃的",
        "Happy words": "开心的词", "Sad words": "难过的词",
        "Instruments": "乐器", "Stationery": "文具",
        "Toys": "玩具", "Vegetables": "蔬菜",
        "Plant": "植物", "Plants": "植物",
