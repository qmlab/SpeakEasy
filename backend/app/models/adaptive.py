...
class DevelopmentalProfile(Base):
    ...
    ceiling_level = Column(Integer, nullable=True)  # Highest level before ceiling rule triggered
    basal_level = Column(Integer, nullable=True)     # Floor level (basal rule: 5 successes in a row)
