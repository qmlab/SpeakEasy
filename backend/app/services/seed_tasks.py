    ...
    tasks.extend([
        AdaptiveTask(
            ...
            content={
                ...
                "choices": [
                    {"action": "clap_hands", "label": "Clap hands", "is_correct": True},
                    {"action": "stomp_feet", "label": "Stomp feet", "is_correct": False},
        ...
        AdaptiveTask(
            ...
            content={
                ...
                "choices": [
                    {"action": "sit_down", "label": "Sit down", "is_correct": False},
        ...
        AdaptiveTask(
            ...
            content={
                ...
                "choices": [
                    {"action": "wave_goodbye", "label": "Wave goodbye", "is_correct": True},
                    {"action": "clap_hands", "label": "Clap hands", "is_correct": False},
                    {"action": "nod_head", "label": "Nod head", "is_correct": False},
                ],
            },
            is_assessment=False,
        ),
    ...
    tasks.extend([
        ...
        AdaptiveTask(
            ...
            content={
                ...
                "game": "block_tower",
                "sequence": ["bunny_places", "your_turn", "bunny_places", "your_turn"],
                "current_step": 1,
            },
            is_assessment=False,
        ),
    ...
    tasks.extend([
        AdaptiveTask(
            ...
            content={
                ...
                "scene": "lonely_bear",
                "choices": [
                    {"action": "say_hi", "label": "Say hi to the bear", "is_best": True},
        ...
        AdaptiveTask(
            ...
            content={
                ...
                "scene": "ask_to_play",
                "choices": [
                    {"action": "ask_play", "label": "Can I play with you?", "is_best": True},
                    {"action": "take_toy", "label": "Take the toy", "is_best": False},
        ...
        AdaptiveTask(
            ...
            content={
                ...
                "scene": "help_duck",
                "choices": [
                    {"action": "pick_up", "label": "Pick it up and give it back", "is_best": True},
    ...
    tasks.extend([
        AdaptiveTask(
            ...
            content={
                ...
                "items": [
                    {"name": "Red Star", "color": "red", "shape": "star", "pair_id": "A"},
                    {"name": "Blue Circle", "color": "blue", "shape": "circle", "pair_id": "B"},
                    {"name": "Red Star", "color": "red", "shape": "star", "pair_id": "A"},
                    {"name": "Green Square", "color": "green", "shape": "square", "pair_id": "C"},
                ],
                "correct_pair": "A",
            },
            is_assessment=True,
        ...
        AdaptiveTask(
            ...
            content={
                ...
                "instruction_text": "Find the matching pair.",
                "items": [
                    {"name": "Yellow Triangle", "color": "yellow", "shape": "triangle", "pair_id": "A"},
                    {"name": "Blue Circle", "color": "blue", "shape": "circle", "pair_id": "B"},
                    {"name": "Red Square", "color": "red", "shape": "square", "pair_id": "C"},
                    {"name": "Yellow Triangle", "color": "yellow", "shape": "triangle", "pair_id": "A"},
                ],
                "correct_pair": "A",
            },
