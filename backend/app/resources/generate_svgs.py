...
SVG_FOOTER = "</svg>\n"
BG_CIRCLE = '<circle cx="60" cy="60" r="56" fill="{bg}" stroke="{stroke}" stroke-width="3"/>\n'
...
make_svg("butterfly", "#FCE4EC", "#AD1457",
...
make_svg("elephant", "#ECEFF1", "#546E7A",
...
make_svg("penguin", "#E8EAF6", "#283593",
...
make_svg("dolphin", "#E1F5FE", "#01579B",
...
make_svg("strawberry", "#FFEBEE", "#B71C1C",
...
make_svg("watermelon", "#E8F5E9", "#1B5E20",
...
make_svg("ice_cream", "#FCE4EC", "#880E4F",
...
make_svg("airplane", "#E8EAF6", "#283593",
...
make_svg("bicycle", "#E8F5E9", "#1B5E20",
...
make_svg("rainbow", "#F3E5F5", "#7B1FA2",
...
make_svg("snowman", "#ECEFF1", "#455A64",
...
make_svg("scissors", "#FCE4EC", "#C62828",
...
make_svg("umbrella", "#E1F5FE", "#01579B",
...
make_svg("teddy_bear", "#EFEBE9", "#5D4037",
...
make_svg("happy_face", "#FFF8E1", "#FF6F00",
...
make_svg("thumbs_up", "#E8F5E9", "#2E7D32",
...
make_svg("stop_hand", "#FFEBEE", "#C62828",
...
make_svg("sleeping", "#E8EAF6", "#283593",
...
make_svg("flashlight", "#FFF8E1", "#F57F17",
...
make_svg("chopsticks", "#EFEBE9", "#4E342E",
...
make_svg("dim_object_cognition", "#E8F5E9", "#2E7D32",
...
make_svg("dim_language_expression", "#E3F2FD", "#1565C0",
...
make_svg("dim_language_comprehension", "#FFF3E0", "#E65100",
...
make_svg("dim_literacy", "#F3E5F5", "#7B1FA2",
...
make_svg("dim_social_behavior", "#FCE4EC", "#C62828",
...
make_svg("dim_cognitive_logic", "#E8EAF6", "#283593",
...
make_svg("reward_star", "#FFF8E1", "#FF6F00",
...
make_svg("reward_trophy", "#FFF8E1", "#FF6F00",
...
make_svg("reward_ribbon", "#E8EAF6", "#283593",
...
make_svg("reward_fireworks", "#1A237E", "#FFD740",
